...
Usage:
    python spotim8/scripts/automation/sync.py              # Full sync + update
    python spotim8/scripts/automation/sync.py --skip-sync  # Update only (fast, uses existing data)
    python spotim8/scripts/automation/sync.py --sync-only  # Sync only, no playlist changes
    python spotim8/scripts/automation/sync.py --all-months # Process all months, not just current
...
Run locally or via cron:
    ...
    0 2 * * * cd /path/to/spotim8 && /path/to/venv/bin/python spotim8/scripts/automation/runner.py
"""
...
from spotim8.features.genres import (
    SPLIT_GENRES,
...
from spotim8.features.genre_inference import (
    infer_genres_comprehensive,
    enhance_artist_genres_from_playlists
)

# Import configuration from config module
from spotim8.scripts.automation.config import *

# Import formatting utilities from formatting module
from spotim8.scripts.automation.formatting import format_playlist_name, format_playlist_description, format_yearly_playlist_name

# Import playlist operations from extracted modules
from spotim8.scripts.automation.playlist_creation import create_or_update_playlist
from spotim8.scripts.automation.playlist_update import update_monthly_playlists, update_genre_split_playlists, update_master_genre_playlists
from spotim8.scripts.automation.playlist_consolidation import consolidate_old_monthly_playlists, delete_old_monthly_playlists, delete_duplicate_playlists

# Import common API helpers
from spotim8.scripts.common.api_helpers import api_call, chunked as chunked_helper
...
import spotim8.features.genre_inference as genre_inference_module
...
def _get_genres_from_track_uris(track_uris: list) -> tuple:
    ...
    """
    from collections import Counter
    from spotim8.features.genres import get_all_broad_genres
