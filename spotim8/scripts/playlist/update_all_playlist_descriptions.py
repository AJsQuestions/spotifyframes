...
Usage:
    python spotim8/scripts/playlist/update_all_playlist_descriptions.py
    python spotim8/scripts/playlist/update_all_playlist_descriptions.py --dry-run  # Preview changes
"""
...
from spotim8.scripts.automation.sync import _update_playlist_description_with_genres
